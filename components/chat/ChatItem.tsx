...
export const roleIconMap = {
  [MemberRole.GUEST]: <Shield size={16} className="ml-2 text-rose-500" />,
  [MemberRole.MODERATOR]: (
    <ShieldAlert size={16} className="ml-2 text-indigo-500" />
  ),
  [MemberRole.ADMIN]: (
    <ShieldCheck size={16} className="ml-2 text-indigo-500" />
  ),
};
